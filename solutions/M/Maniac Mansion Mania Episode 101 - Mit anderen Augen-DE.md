...
- BENUTZE `Pflanzentaschenlampe` mit (rechtem) Blumentopf
- NIMM Goldregen (`Goldregenblüten`)
- >Easter Egg:
  >- BENUTZE `Pflanzentaschenlampe` mit (linker) Pflanze

#### 2.2.25. Flur zweite Etage

- >Easter Egg:
  >- BENUTZE `Pflanzentaschenlampe` mit schöne Pflanze

#### 2.2.26. Musikzimmer

- >Easter Egg:
  >- BENUTZE `Pflanzentaschenlampe` mit Vase

#### 2.2.27. Unterer Eingangsbereich

- >Easter Egg:
  >- BENUTZE `Pflanzentaschenlampe` mit **beiden** Pflanzen

##### 2.2.27.1. Bibliothek

- >Easter Egg:
  >- BENUTZE `Pflanzentaschenlampe` mit Chuck

### 2.3. Vor dem Tollhaus

- >Easter Egg:
  >- BENUTZE `Pflanzentaschenlampe` mit (rechtem) Busch
- BENUTZE `Pflanzentaschenlampe` mit (linkem) Busch
- NIMM Essigflasche (`Essig`)

### 2.4. Tollhaus

#### 2.4.1. Laboreingang

- BENUTZE `Essig` mit Dr. Fred
- BENUTZE `Öl` mit Dr. Fred
- BENUTZE `Goldregenblüten` mit Dr. Fred
- BENUTZE `Goldnugget` mit Dr. Fred

## 3. Haus der Bernoullis

#### 3.0.2. Wohnzimmer

- >Easter Egg:
  >- BENUTZE `Pflanzentaschenlampe` mit Vase
- BENUTZE `Socke` mit `Hamster in Salatschleuder`

#### 3.0.3. Flur Obergeschoss

##### 3.0.3.1. Bernard's Zimmer

- NIMM rotes Ding (`Eimer`)
- ÖFFNE hellbrauner Rahmen (hinten)
- ÖFFNE braunes Parallelogramm
- NIMM braunes Parallelogramm (offen) (`Zeug aus Stoff`)
- BENUTZE `Zeug aus Stoff` mit `Eimer` (`Eimer mit Seil`)
- BENUTZE `Eimer mit Seil` mit hellbrauner Rahmen (hinten)
- NIMM noch mehr Bücher (`Buch`)
- >Easter Egg:
  >- BENUTZE `Buch` **kann beliebig oft wiederholt werden**
- ÖFFNE Morsealphabet (`Videotape`, `Safe`)
- BENUTZE `Videotape` mit Fernseher (`Hinweis 1`, `Hinweis 2`, `Hinweis 3`)
- BENUTZE `Hinweis 1` mit "Pi - alle Stellen der Kreiszahl zum Nachlesen"
- BENUTZE `Hinweis 2` mit "Hawqueens Universum"
- BENUTZE `Hinweis 3` mit dir selbst
- ZIEHE `Hinweis 2` (`Kleiner Schlüssel`)
