...
- BENUTZE `Pinsel` mit `Tasse` (`Pinsel mit Harz`)
...
- BENUTZE `Gewichte` mit Grammophon
...
- BENUTZE `Zange` mit Brett (an den Fässern rechts) (`Langes Brett`)
...
- VERLASSE Richtung Ausgang links
...
### 18.11. Vor der Forschungsstation
